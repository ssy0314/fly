                                        ...
                                        <select lay-verify="required" name="class" lay-filter="column">
                                            ...
                                            <c:if test="${cateList != null}">
                                                <c:forEach items="${cateList}" var="category">
                                                    <option value="${category.id}">${category.cateNameZh}</option>
                                                </c:forEach>
                                            </c:if>
                                        </select>
                                    </div>
...
<script>
    ...
    var kissNum = '${fly_user.kissNum}';
    document.getElementById('articleForm').onsubmit = function (ev) {
        var costKiss = document.getElementById('kiss').value;
        if(parseInt(costKiss) > parseInt(kissNum)){
            document.getElementById('kissMsg').innerHTML = '您当前只有'+parseInt(kissNum)+'飞吻数'
            return false;
        }
    }
