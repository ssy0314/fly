...
<c:if test="${indexInfo!=null}">
    <c:forEach items="${indexInfo.categoryList}" var="cate">
        ...
        <div class="fly-column-right layui-hide-xs">
            ...
            <a href="${pageContext.servletContext.contextPath}/add" class="layui-btn">发表新帖</a>
        </div>
...
<%--                    <span class="fly-signin-days">已连续签到<cite>16</cite>天</span>--%>
                ...
                <div class="fly-panel-main fly-signin-main">
                    <c:if test="${msg==false}">
                    <form action="${pageContext.servletContext.contextPath}/user/sign" method="post">
...
<script>
    ...
    layui.config({
        version: "3.0.0"
        ,base: '${pageContext.servletContext.contextPath}/res/mods/' //这里实际使用时，建议改成绝对路径
    }).extend({
        fly: 'index'
    }).use('fly');
